  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 border-2 border-gray-100 shadow-sm">
        <h6 className="font-bold text-md text-gray-900 mb-4 flex items-center gap-2">
        ...
        <div className="space-y-4">
          <div className="relative">
            <input
              ...
              className="w-full py-2 px-4 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all duration-200 font-medium"
            />
          </div>
          <div className="relative">
            <input
          ...
          <div className="relative">
            <input
              ...
              className={`w-full py-2 px-4 border-2 rounded-xl focus:ring-2 outline-none transition-all duration-200 font-medium ${
                phoneError
      ...
      <div className="bg-white rounded-2xl p-6 border-2 border-gray-100 shadow-sm">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block font-bold text-gray-700 mb-3">Adults</label>
            <input
              type="number"
              min="1"
              max={availableSeats}
              ...
              className="w-full py-2 px-4 border-2 border-gray-200 rounded-xl focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none transition-all duration-200 font-medium text-center text-lg"
            />
          </div>
          <div>
            <label className="block font-bold text-gray-700 mb-3">Infants</label>
            <input
              type="number"
              min="0"
      ...
      {passengers.length > 0 && (
        <div className="space-y-4">
          ...
          {passengers.map((passenger, index) => {
            ...
            return (
              <div key={index} className="bg-white rounded-2xl p-6 border-2 border-gray-100 shadow-sm">
                ...
                <div className="space-y-4">
                  <input
                    ...
                    className="w-full py-2 px-4 border-2 border-gray-200 rounded-xl focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all duration-200 font-medium"
                  />
                  <input
                    type="text"
                    placeholder={
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full py-2 px-4 border-2 border-gray-200 rounded-xl focus:border-orange-500 outline-none transition-all duration-200 font-medium file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-orange-700 hover:file:bg-orange-100"
                    />
      ...
      <div className="bg-white rounded-2xl p-6 border-2 border-gray-100 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div>
            <label className="block font-bold text-gray-700 mb-3">Trip Type</label>
            <select
              ...
              className="w-full py-2 px-4 border-2 border-gray-200 rounded-xl focus:border-teal-500 focus:ring-2 focus:ring-teal-200 outline-none transition-all duration-200 font-medium bg-white disabled:opacity-60"
            >
          ...
          <div>
            <label className="block font-bold text-gray-700 mb-3">Selected Price</label>
            <input
              type="text"
              value={selectedPriceLabel}
              disabled
              className="w-full py-2 px-4 border-2 border-gray-200 rounded-xl bg-gray-50 text-gray-900 font-semibold cursor-not-allowed"
            />
          </div>
          <div>
            <label className="block font-bold text-gray-700 mb-3">Estimated Total</label>
            <input
              type="text"
              value={formattedTotalAmount}
              disabled
              className="w-full py-2 px-4 border-2 border-teal-100 rounded-xl bg-gray-50 text-gray-900 font-semibold cursor-not-allowed"
            />
          </div>
        </div>
        <div className="mt-6 p-4 bg-linear-to-r from-teal-50 to-blue-50 rounded-xl border border-teal-200">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold text-gray-900">{formatCurrencyValue(seatTotal)}</span>
            </div>
            {numberOfInfants > 0 && (
              <div className="flex justify-between items-center">
                <span className="text-gray-700">
                ...
                <span className="font-semibold text-gray-900">{formatCurrencyValue(infantsTotal)}</span>
              </div>
            )}
            <div className="border-t border-teal-300 pt-2 mt-2 flex justify-between items-center">
              <span className="font-bold text-gray-900">Total Amount</span>
              <span className="text-lg font-bold text-teal-700">{formattedTotalAmount}</span>
            </div>
          </div>
        </div>
